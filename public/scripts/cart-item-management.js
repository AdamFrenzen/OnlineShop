const cartItemUpdateFormElements = document.querySelector('.cart-item-management');
...
async function updateCartItem(event) {
    ...
    cartItemTotalPriceElement.textContent = responseData.updatedCartItem.updateItemPrice.toFixed(2);
